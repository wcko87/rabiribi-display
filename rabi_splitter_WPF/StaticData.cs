...
namespace rabi_splitter_WPF
{
    public static partial class StaticData
    {
        ...
        public static int[] EnenyPtrAddr = { 0x00940EE0, 0x00964A1C, 0x0096BA3C, 0x0096DA3C, 0x012E1AF8, 0x012E2B08, 0x012E3B08 };
        public static int[] EnenyEnitiyHPOffset = { 0x4c8, 0x4d0, 0x4d8, 0x4d8, 0x4d8, 0x4d8, 0x4d8 };
        public static int[] EnenyEnitiyMaxHPOffset = { 0, 0, 0, 0x4e8, 0x4e8, 0x4e8, 0x4e8 };
        public static int[] EnenyEnitiyIDOffset = { 0x4e4,0x4ec, 0x4F4, 0x4F4 , 0x4F4 , 0x4F4, 0x4F4 };
        public static int[] EnenyEntitySize = {0x6F4, 0x6FC, 0x704, 0x704 , 0x704 , 0x704, 0x704};
        public static int[] EnenyEnitiyIsActiveOffset = { 0, 0, 0, 0x674, 0x674, 0x674, 0x674 };
        public static int[] EnenyEnitiyAnimationOffset = { 0, 0, 0, 0x678, 0x678, 0x678, 0x678 };
        public static int[] MaxEntityEntry = {50 ,50, 50, 50, 50, 50, 50};
